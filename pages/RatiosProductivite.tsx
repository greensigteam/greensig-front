    ...
    const columns: Column<RatioProductivite>[] = [
        {
            ...
            label: 'Type de tâche',
            render: (r) => (
                <span className="font-medium text-slate-900">{r.type_tache_nom}</span>
            )
        },
        {
            key: 'type_objet',
            label: 'Type d\'objet',
            render: (r) => (
                <span className="bg-slate-100 px-2 py-1 rounded text-sm">{r.type_objet}</span>
            )
        },
        {
            key: 'ratio',
        ...
        },
        {
            ...
            render: (r) => (
                r.actif ? (
                    ...
                    <span className="bg-slate-100 text-slate-500 text-xs px-2 py-1 rounded-full">Inactif</span>
                )
            )
        },
        {
            ...
            render: (r) => (
                <div className="flex items-center gap-1">
                    <button
                        onClick={(e) => { e.stopPropagation(); setRatioDetails(r); }}
                    ...
                    <button
                        onClick={(e) => { e.stopPropagation(); setSelectedRatio(r); setShowForm(true); }}
                    ...
                    <button
                        onClick={(e) => { e.stopPropagation(); setRatioToDelete(r.id); }}
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg">
                        ...
                        <div className="p-6 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="p-3 bg-slate-50 rounded-lg">
                                    ...
                                    <p className="font-mono font-bold text-2xl text-emerald-600">
                                        {ratioDetails.ratio}<span className="text-slate-400 text-sm font-normal">/h</span>
                                    </p>
                                </div>
                                <div className="p-3 bg-slate-50 rounded-lg">
                                    <p className="text-xs text-slate-500 mb-1">Unité</p>
                                    <p className="font-medium text-slate-900">{UNITE_MESURE_LABELS[ratioDetails.unite_mesure]}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                                ...
                                {ratioDetails.actif ? (
                                    <span className="bg-green-100 text-green-700 text-sm font-medium px-3 py-1 rounded-full">Actif</span>
                                ) : (
                                    <span className="bg-slate-100 text-slate-500 text-sm font-medium px-3 py-1 rounded-full">Inactif</span>
                                )}
                            </div>
