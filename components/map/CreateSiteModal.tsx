  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const siteData: CreateSiteData = {
        ...
        superficie_totale: formData.superficie_totale ? parseFloat(formData.superficie_totale) : undefined,
  ...
  return (
    ...
    >
      ...
      <FormSection
        ...
        description="Identité et localisation du site"
      >
        <FormGrid columns={1}>
          {isLoadingClients ? (
            ...
            <PremiumSelect
              ...
              onChange={(value) => handleChange('client', value ? parseInt(value) : null)}
