...
export const DistributionEditForm: React.FC<DistributionEditFormProps> = ({
    ...
    const handleSave = async () => {
        ...
        const [hDebut, mDebut] = editedHeureDebut.split(':').map(Number);
        const [hFin, mFin] = editedHeureFin.split(':').map(Number);
        ...
        try {
            ...
            console.error('Erreur lors de la modification de la distribution:', error);
                ...
                <div className="p-6 space-y-6 flex-1 overflow-y-auto">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-500">Ajustez la date et les heures de cette intervention</p>
                        </div>
                    </div>
