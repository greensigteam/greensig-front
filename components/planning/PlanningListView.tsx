...
import { Calendar as CalendarIcon, Clock, Users, MapPin, AlertTriangle, CheckCircle2 } from 'lucide-react';
import { Tache, STATUT_TACHE_LABELS, STATUT_TACHE_COLORS, PRIORITE_LABELS } from '../../types/planning';
import { StatusBadge } from '../StatusBadge';
import type { PopoverInfo } from '../../hooks/usePlanningData';
...
const TaskListItem: FC<TaskListItemProps> = ({ tache, dateKey, onClick, isReadOnly }) => {
    ...
    const isCompleted = distribution ? distribution.status === 'REALISEE' : tache.statut === 'TERMINEE';
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-2">
                        <h3 className={`text-base font-medium ${isCompleted ? 'line-through text-gray-400' : 'text-gray-800'}`}>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500">
                        ...
                        <div className="flex items-center gap-1.5">
                            ...
                            <span>{heureDebut.slice(0, 5)} - {heureFin.slice(0, 5)}</span>
                        </div>
