...
import {
    ChevronLeft, ChevronRight, ChevronDown, Download, Calendar as CalendarIcon, List, Filter, X
} from 'lucide-react';
import { PlanningFilters } from '../../types/planning';
    ...
    return (
        <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center px-3 md:px-6 py-2 md:py-3 border-b border-gray-200 gap-2 md:gap-4 bg-white z-20">
            ...
            <div className="flex items-center gap-2 md:gap-4 w-full sm:w-auto overflow-x-auto scrollbar-hide py-1">
                ...
                {viewMode === 'list' && (
                    <h2 className="text-sm md:text-xl font-normal text-gray-800 shrink-0">Agenda des tâches</h2>
                )}
            </div>
            ...
            <div className="flex items-center gap-2 md:gap-3 w-full sm:w-auto justify-between sm:justify-end">
                ...
                <div className="relative">
                    <button
                        ...
                        className={`relative p-2.5 rounded-xl transition-all duration-200 shrink-0 min-w-[44px] min-h-[44px] flex items-center justify-center ${showFilters || activeFiltersCount > 0
                    ...
                    {showFilters && (
                        <>
                            ...
                            <div className="md:hidden fixed inset-0 bg-black/50 z-[99]" onClick={() => setShowFilters(false)} />
