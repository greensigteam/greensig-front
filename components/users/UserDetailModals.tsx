...
import { fetchOperateurById, fetchClientByUserId } from '../../services/usersApi';
...
export const OperateurDetailModal: React.FC<OperateurDetailModalProps> = ({
  ...
  // Note: Les opérateurs sont maintenant des données RH standalone sans compte utilisateur.
  // Cette modal affiche les infos de base de l'utilisateur.
  const loading = false;
            ...
            <>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-blue-700">
                  Cet utilisateur a accès au système.
                  Les opérateurs terrain sont gérés séparément dans la section Équipes.
                </p>
              </div>
