...
export default function CreateSuperviseurModal({ isOpen, onClose, onCreated }: CreateSuperviseurModalProps) {
    ...
    return (
        ...
        >
            ...
            <FormSection
                ...
                description="Identité du superviseur"
            >
                <FormGrid columns={2}>
                    <PremiumInput
                        type="text"
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-emerald-700">
                            Ce compte aura accès à la gestion des équipes, la planification des tâches et le suivi des interventions.
                            Le rôle SUPERVISEUR sera automatiquement assigné lors de la création.
                        </p>
                    </div>
                </div>
            </div>
