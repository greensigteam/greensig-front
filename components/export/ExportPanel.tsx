...
import { Download, FileJson, FileSpreadsheet, Map, Package, Loader2, X, Info } from 'lucide-react';
import {
  exportGeoData,
  exportSelection,
  downloadBlob,
      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-start gap-2 p-3 bg-gray-50 rounded-lg text-sm text-gray-600">
            ...
            <p>
              Les formats géographiques (GeoJSON, KML, Shapefile) incluent les coordonnées et
              peuvent être ouverts dans des logiciels SIG.
            </p>
          </div>
        </div>
