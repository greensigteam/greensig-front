...
interface AnnulerDistributionModalProps {
    isOpen: boolean;
    distribution: DistributionCharge | null;
    onClose: () => void;
    onConfirm: (motif: MotifDistribution, commentaire: string) => void;
    isLoading?: boolean;
}

export const AnnulerDistributionModal: React.FC<AnnulerDistributionModalProps> = ({
    isOpen,
    distribution,
    onClose,
    onConfirm,
    ...
    const [motif, setMotif] = useState<MotifDistribution>('CLIENT');
                    ...
                    <div className="flex items-start gap-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-amber-700 mt-1">
                                Une distribution annulée ne pourra pas être restaurée si d'autres actions ont été effectuées.
                            </p>
                        </div>
                    </div>
...
export default AnnulerDistributionModal;
