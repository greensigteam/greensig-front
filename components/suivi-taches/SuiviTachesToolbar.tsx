...
import {
    Filter, Building2, MapPin, Users, Clock, ChevronDown, X, RefreshCw,
    Calendar, ListTodo, CalendarDays, AlertTriangle, Repeat
} from 'lucide-react';
import {
    PlanningFilters, StatutTache,
    DistributionFilters, StatusDistribution, STATUS_DISTRIBUTION_LABELS
} from '../../types/planning';
...
export const SuiviTachesToolbar: React.FC<SuiviTachesToolbarProps> = ({
    ...
    const currentActiveFiltersCount = viewMode === 'distributions'
        ? distributionActiveFiltersCount
        : activeFiltersCount;
                ...
                <>
                    ...
                    <div className="relative shrink-0">
                        ...
                        <select
                            ...
                            onChange={(e) => handleDistributionFilterChange({
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                        ...
                        <button
                            onClick={() => handleDistributionShortcut('est_report', distributionFilters.est_report)}
                            disabled={loadingTasks}
                            className={`
                                flex items-center gap-1 px-3 py-2 rounded-lg text-sm font-medium transition-all border-2
