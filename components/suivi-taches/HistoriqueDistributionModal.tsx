...
import { X, History, ArrowRight, CheckCircle, XCircle, Clock, AlertTriangle, CalendarClock } from 'lucide-react';
import {
                                                ...
                                                <div className="flex items-start justify-between gap-2">
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-slate-600 mt-1">
                                                            ...
                                                            {item.heures_reelles && ` / ${item.heures_reelles.toFixed(2)}h réelles`}
                                                        </p>
                                                    </div>
                                                    <span className={`inline-flex items-center px-2 py-0.5 text-xs font-medium rounded-full ${statusColors?.bg || 'bg-slate-100'} ${statusColors?.text || 'text-slate-700'}`}>
                                                        {STATUS_DISTRIBUTION_LABELS[item.status as StatusDistribution] || item.status}
                                                    </span>
                                                </div>
