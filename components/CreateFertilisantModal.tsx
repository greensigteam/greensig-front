...
interface CreateFertilisantModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (data: FertilisantCreate) => Promise<void>;
}

const CreateFertilisantModal: React.FC<CreateFertilisantModalProps> = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error('Erreur creation fertilisant:', err);
    ...
    return (
        <FormModal
            ...
            title="Nouveau fertilisant"
            subtitle="Ajouter un fertilisant au catalogue"
            icon={<Leaf className="w-5 h-5 text-green-600" />}
            size="lg"
            loading={loading}
            error={error}
            submitLabel="Creer le fertilisant"
            cancelLabel="Annuler"
        ...
        >
            ...
            <FormSection
                title="Statut"
                description="Disponibilite du fertilisant dans le systeme"
            >
                <div
...
export default CreateFertilisantModal;
