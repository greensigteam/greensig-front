...
import { createReclamation, updateReclamation, uploadPhoto, fetchReclamationById } from '../../services/reclamationsApi';
...
export const ReclamationEditModal: React.FC<ReclamationEditModalProps> = ({
    ...
    const [formData, setFormData] = useState<Partial<ReclamationCreate & { visible_client?: boolean }>>({});
