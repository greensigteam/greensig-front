    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Renseignez les informations de l'objet</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="p-6">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-medium text-red-800">Position invalide</h3>
                <p className="text-sm text-red-600 mt-1">{siteError}</p>
            ...
            {isDetectingSite ? (
              ...
              <div className="w-full px-3 py-2.5 border rounded-lg bg-emerald-50 border-emerald-200">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-emerald-800">{detectedSite.site.nom_site}</span>
